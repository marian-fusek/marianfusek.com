...
| Matchup score and projection presentation | DONE | Matchup shows the selected team and its real ESPN opponent side by side, current points, projected totals, explicit LIVE/FINAL/UPCOMING state, lineup-lock context, and the active week without inserting an extra dashboard card between the score and rosters. A future week no longer falls back to prior-week player totals. |
