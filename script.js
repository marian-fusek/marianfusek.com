(()=>{
  ...
  if(initiativesSection){
    ...
    const initiativeData={
      ...
      kokoji:{name:'Kokoji',image:'media/initiatives/vibe-coding/app_kokoji.jpg',copy:['Kokoji is a tiny opinionated creature living somewhere on your Mac, mostly concerned with your water intake, the state of her room, and your questionable decisions. You check in, add a drink and poke around. Over time the place starts changing, new things appear, conversations get stranger, and Kokoji develops more reasons to comment on what you’re doing.','There are no streaks, guilt trips, or productivity sermons. Just a weird little world, dry jokes, occasional insults, and a creature who somehow became involved in your hydration.'],type:'MacOS App',status:'Final Tweaks'},
